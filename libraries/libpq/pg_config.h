...
#define CONFIGURE_ARGS " '--prefix=/usr/local/pgsql' '--without-readline' '--without-zlib' '--with-icu' 'ICU_LIBS=-L/usr/lib/x86_64-linux-gnu -licui18n -licuuc -licudata' 'ICU_CFLAGS=-I/usr/include/x86_64-linux-gnu' 'CFLAGS=-I/usr/include/x86_64-linux-gnu'"
...
#define PG_VERSION_STR "PostgreSQL 17.2 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0, 64-bit"
